...
class DiscordClient
{
	...
	private static var presence:DiscordRichPresence = DiscordRichPresence.Initialize();
	...
	{
		var discordHandlers:DiscordEventHandlers = DiscordEventHandlers.Initialize();
